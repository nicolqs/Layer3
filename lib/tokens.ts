...
export const POPULAR_TOKENS: Record<number, TokenInfo[]> = {
  ...
  1: [
    ...
    { address: '0x6B175474E89094C44Da98b954EedeAC495271d0F', symbol: 'DAI', name: 'Dai Stablecoin', decimals: 18, logo: 'https://cryptologos.cc/logos/multi-collateral-dai-dai-logo.svg' },
  ...
  137: [
    ...
    { address: '0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063', symbol: 'DAI', name: 'Dai Stablecoin', decimals: 18, logo: 'https://cryptologos.cc/logos/multi-collateral-dai-dai-logo.svg' },
    ...
    { address: '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', symbol: 'WMATIC', name: 'Wrapped Matic', decimals: 18, logo: 'https://cryptologos.cc/logos/polygon-matic-logo.svg' },
  ],
  ...
  42161: [
    ...
    { address: '0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1', symbol: 'DAI', name: 'Dai Stablecoin', decimals: 18, logo: 'https://cryptologos.cc/logos/multi-collateral-dai-dai-logo.svg' },
    ...
    { address: '0x912CE59144191C1204E64559FE8253a0e49E6548', symbol: 'ARB', name: 'Arbitrum', decimals: 18, logo: 'https://cryptologos.cc/logos/arbitrum-arb-logo.svg' },
  ],
  ...
  8453: [
    ...
    { address: '0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb', symbol: 'DAI', name: 'Dai Stablecoin', decimals: 18, logo: 'https://cryptologos.cc/logos/multi-collateral-dai-dai-logo.svg' },
    { address: '0x4200000000000000000000000000000000000006', symbol: 'WETH', name: 'Wrapped Ether', decimals: 18, logo: 'https://cryptologos.cc/logos/ethereum-eth-logo.svg' },
  ],
};
...
export function getTokenLogo(symbol: string): string {
  ...
  return logoMap[symbol] || 'https://cryptologos.cc/logos/ethereum-eth-logo.svg';
}
